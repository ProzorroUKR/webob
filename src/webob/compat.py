    ...
    class cgi_FieldStorage(_cgi_FieldStorage): # pragma: no cover
        ...
        def __init__(self, fp=None, headers=None, outerboundary=b'',
            ...
            if 'filename' in pdict:
                ...
                name_parts = pdict['filename*'].split("'")
                if len(name_parts) == 3:
                    f_name_encoding, _, f_name = name_parts
                    self.filename = urlparse.unquote(f_name, encoding=f_name_encoding)
    ...
    class cgi_FieldStorage(_cgi_FieldStorage):  # pragma: no cover
        def __init__(self, fp=None, headers=None, outerboundary="",
            ...
            if 'filename' in pdict:
                ...
                if len(name_parts) == 3:
                    f_name_encoding, _, f_name = name_parts
                    self.filename = urlparse.unquote(f_name)
